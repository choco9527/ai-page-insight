...
const {sleep, getTextByOcrSingle, concatenateImages, concatenateImagesWithOrderText} = require('./common');
const {launchConfig, cookiesArray} = require('./constans');
const {_grayData, _initVideo, _getVideoData} = require('./helper')

const aiPageHandler = async function (
  {
    captionHeight = 60,
    outputFilePath = 'test_out_put.png'
  }) {
  // 最终需要的数据集合
  const dataMap = {}
  try {
